...
<jsp:include page="../Member/top.jsp"></jsp:include>
	...
	<div class="col-sm-7">
   		...
   		<hr>
         	...
         	<h2 class="hn" style="margin-left: 5px"><b class="glyphicon glyphicon-th-list" style="margin-right: 10px;"></b>팀일정</h2>
      	<hr>
      </div>
...
<fmt:parseNumber var="end" value="${scheend }" pattern="yyyy-mm-dd"></fmt:parseNumber>
<fmt:formatDate value="${end}" pattern="yyyy-mm-dd"/>
<fmt:parseNumber value="${today.time/(1000*60*60*24)}" integerOnly="true" var="now" scope="request"></fmt:parseNumber>
<fmt:parseNumber value="${end.time/(1000*60*60*24)}" integerOnly="true" var="endday" scope="request"></fmt:parseNumber>
				</c:if>
